...
- API: `/api-new`, `/api-test`, `/api-protect`, `/api-protect-convex`
- UI: `/component-new`, `/page-new`
- Supabase: `/types-gen`, `/edge-function-new`
- Convex: `/schema-gen`, `/function-new`
...
`~/Documents/GitHub/pras-claude-code/`
...
4. **Test Installation** - `/plugin install andhikapraa/pras-claude-code`
...
https://github.com/andhikapraa/pras-claude-code
